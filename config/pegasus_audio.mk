...
ALARM_PATH := vendor/pegasus/prebuilt/common/media/audio/alarms
NOTIFICATION_PATH := vendor/pegasus/prebuilt/common/media/audio/notifications
RINGTONE_PATH := vendor/pegasus/prebuilt/common/media/audio/ringtones
